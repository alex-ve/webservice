...
function mw1() {
    echo "This is 1 middleware!";
}
function mw2() {
    echo "This is 2 middleware!";
}
...
$app->get('/hello/:name', function ($name)  use ($app) {
    ...
    echo "Hello, " . $name . " - user:[". $username ."]|[".$password."]";
	$app->response->setStatus(200);
	
});
/*
per poter richiamare una file php situato in una directory specifica
$app->config(array(
    'debug' => true,
